...
export default class HeaderManu extends Component {
    constructor() {
        ...
        this.state = {user:access[0], isActiveAside: false, appThemeSkin : 'light'};
    }
    setMode = (ele) => {
        const htmlTag = document.getElementsByTagName("html")[0];
        htmlTag.setAttribute("data-theme", ele);
        this.setState({ appThemeSkin: ele });
    };

    render() {
        const {appThemeSkin,user} = this.state;
        return (
          <>  
            <div className="header-menu d-flex align-items-center justify-content-end w-xs-100 h-100">
                <div className="d-flex align-items-center h-100 flex-shrink-0">
                    <Dropdown id="head_skin_" align="end" className="block-center position-relative head_skin_">
                        <Dropdown.Toggle variant="" className="btn btn-icon btn-active-light p-0 transition-none arrow_disabled">
                        ...
                        <Dropdown.Menu>
                            <div className="menu-item px-2">
                                <Dropdown.Item href="#" className={`${appThemeSkin === 'light' ? 'active ' : ''}px-3 py-2`} onClick={() => this.setMode("light")}>
                                    ...
                                    <span className="ms-2 menu-title font-weight-bold">Light</span>
                                </Dropdown.Item>
                            </div>
                            <div className="menu-item px-2">
                                <Dropdown.Item href="#" className={`${appThemeSkin === 'dark' ? 'active ' : ''}px-3 py-2`} onClick={() => this.setMode("dark")}>
                                    <span className="svg-icon svg-icon-4">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M19.0647 5.43757C19.3421 5.43757 19.567 5.21271 19.567 4.93534C19.567 4.65796 19.3421 4.43311 19.0647 4.43311C18.7874 4.43311 18.5625 4.65796 18.5625 4.93534C18.5625 5.21271 18.7874 5.43757 19.0647 5.43757Z" fill="currentColor"></path>
                                            <path d="M20.0692 9.48884C20.3466 9.48884 20.5714 9.26398 20.5714 8.98661C20.5714 8.70923 20.3466 8.48438 20.0692 8.48438C19.7918 8.48438 19.567 8.70923 19.567 8.98661C19.567 9.26398 19.7918 9.48884 20.0692 9.48884Z" fill="currentColor"></path>
                                    ...
                                    <span className="ms-2 menu-title font-weight-bold">Dark</span>
                                </Dropdown.Item>
                            </div>
                            <div className="menu-item px-2">
                                <Dropdown.Item href="#" className={`${appThemeSkin === 'system' ? 'active ' : ''}px-3 py-2`} onClick={() => this.setMode("system")}>
                                    <span className="svg-icon svg-icon-4">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M1.34375 3.9463V15.2178C1.34375 16.119 2.08105 16.8563 2.98219 16.8563H8.65093V19.4594H6.15702C5.38853 19.4594 4.75981 19.9617 4.75981 20.5757V21.6921H19.2403V20.5757C19.2403 19.9617 18.6116 19.4594 17.8431 19.4594H15.3492V16.8563H21.0179C21.919 16.8563 22.6562 16.119 22.6562 15.2178V3.9463C22.6562 3.04516 21.9189 2.30786 21.0179 2.30786H2.98219C2.08105 2.30786 1.34375 3.04516 1.34375 3.9463ZM12.9034 9.9016C13.241 9.98792 13.5597 10.1216 13.852 10.2949L15.0393 9.4353L15.9893 10.3853L15.1297 11.5727C15.303 11.865 15.4366 12.1837 15.523 12.5212L16.97 12.7528V13.4089H13.9851C13.9766 12.3198 13.0912 11.4394 12 11.4394C10.9089 11.4394 10.0235 12.3198 10.015 13.4089H7.03006V12.7528L8.47712 12.5211C8.56345 12.1836 8.69703 11.8649 8.87037 11.5727L8.0107 10.3853L8.96078 9.4353L10.148 10.2949C10.4404 10.1215 10.759 9.98788 11.0966 9.9016L11.3282 8.45467H12.6718L12.9034 9.9016ZM16.1353 7.93758C15.6779 7.93758 15.3071 7.56681 15.3071 7.1094C15.3071 6.652 15.6779 6.28122 16.1353 6.28122C16.5926 6.28122 16.9634 6.652 16.9634 7.1094C16.9634 7.56681 16.5926 7.93758 16.1353 7.93758ZM2.71385 14.0964V3.90518C2.71385 3.78023 2.81612 3.67796 2.94107 3.67796H21.0589C21.1839 3.67796 21.2861 3.78023 21.2861 3.90518V14.0964C15.0954 14.0964 8.90462 14.0964 2.71385 14.0964Z" fill="currentColor"></path>
                                        </svg>
                                    </span>
                                    <span className="ms-2 menu-title font-weight-bold">System</span>
                                </Dropdown.Item>
                            </div>
                        </Dropdown.Menu>
                    </Dropdown>
                    ...
                    {/* <div className="head_upload_ block-center border-end">
                        <button type="button" className="btn btn-icon block-center btn-active-light">
                            ...
                            <span className="ms-2 text-muted d-lg-flex d-none font-weight-bold">Upload</span>
                        </button>
                    </div> */}
                    <Dropdown className="block-center head_notifications_" align="end">
                        <Dropdown.Toggle variant="" id="head_notifications_" className="btn btn-icon btn-active-light p-0 position-relative arrow_disabled">
                            <span className="d-flex align-items-center justify-content-center margin-0">
                                <span className="notifications_count bg-primary text-light-alt position-absolute rounded-circle">{1}</span>
                                <span className="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                        <path fill="none" d="M0 0h24v24H0z"/>
                                        <path d="M18 10a6 6 0 1 0-12 0v8h12v-8zm2 8.667l.4.533a.5.5 0 0 1-.4.8H4a.5.5 0 0 1-.4-.8l.4-.533V10a8 8 0 1 1 16 0v8.667zM9.5 21h5a2.5 2.5 0 1 1-5 0z" fill="currentColor"/>
                                    </svg>
                                </span>
                            </span>
                        </Dropdown.Toggle>
                        ...
                        <Dropdown.Menu className="p-0">
                                ...
                                <div className="d-flex align-items-center py-2">
                                    <div className="d-flex align-items-center flex-grow-1">
                                        ...
                                        <div className="mb-0 me-2">
                                            <a href="/notifications" className="text-hover-primary text-dark fw-bold text-decoration-none">Project Alice</a>
                                            <div className="text-muted fs-8">Phase 1 development</div>
                                        </div>
                                    </div>
                                    <span className="badge text-muted bg-light">1 hr</span>
                                </div>
                                <div className="d-flex align-items-center py-2">
                                    <div className="d-flex align-items-center flex-grow-1">
                                        <div className="symbol symbol-40 bg-light me-3">
                            ...
                            <div className="py-2 text-center border-top block-center">
                                <Dropdown.Item href={"/notification"} className="btn btn-active-color-primary text-muted btn-sm h-auto border-0 w-auto p-1">View All 
                    ...
                    <Dropdown className="block-center user_profile_" align="end">
                        <Dropdown.Toggle variant="" id="user_profile_" className="btn author_profile p-0 border-0 d-block rounded-circle overflow-hidden arrow_disabled">
                            <span className="d-flex align-items-center justify-content-center margin-0">
                                <img src="https://i.pinimg.com/736x/bc/4b/bd/bc4bbd2ce6b43c390187869173b36130.jpg" alt="profile img" className="img-fluid object-center-fit"/>
                            </span>
                        </Dropdown.Toggle>
                        ...
                        <Dropdown.Menu>
                            <div className="d-flex align-items-center justify-content-between w-100 p-3 border-bottom">
                                <div className="d-flex align-items-center me-2">
                                    ...
                                    <div>
                                        <p className="text-dark mb-0"><Link to={"/profile"} className="text-decoration-none"><strong className="text-break">{user.admin_name}</strong></Link></p>
                                        <span className="mb-0 text-muted text-break fs-8">{user.admin_mail_id}</span>
                                    </div>
                                </div>
                                <div className="signout_btn_">
                                    <a href={BASE_URL} className="btn rounded-5 text-muted text-nowrap border py-1"  onClick={()=>localStorage.removeItem("access")}> Sign Out </a>
                                </div>
                            </div>
                            <div className="px-3">
                                <Link to={"/profile"} className="navi-item px-0 py-3 border-bottom dropdown-item">
                                    <div className="symbol symbol-40 bg-light me-3">
                                        <div className="symbol-label">
                                            <span className="svg-icon svg-icon-md">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M20 22h-2v-2a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3v2H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12 6 6 0 0 1 0 12zm0-2a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" fill="currentColor"/></svg>
                                            </span>
                                        </div>
                                    </div>
                                    <div className="navi-text">
                                        <div className="text-dark h6 mb-1">My Profile</div>
                                        <div className="text-muted fs-8">View/Edit your personal information </div>
                                    </div>
                                </Link>

                                <Link to={"/change-password"} className="navi-item px-0 py-3 border-bottom dropdown-item">
                                    <div className="symbol symbol-40 bg-light me-3">
                                        <div className="symbol-label">
                                            <span className="svg-icon svg-icon-md">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M20 22h-2v-2a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3v2H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12 6 6 0 0 1 0 12zm0-2a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" fill="currentColor"/></svg>
                                    ...
                                    <div className="navi-text">
                                        <div className="text-dark h6 mb-1">Change Password</div>
                                        <div className="text-muted fs-8">Edit your password </div>
                                    </div>
                                </Link>
                                <Link href={"/notification"} className="navi-item px-0 py-3 border-bottom dropdown-item">
                                    <div className="symbol symbol-40 bg-light me-3">
                                        <div className="symbol-label">
                                            <span className="svg-icon svg-icon-md">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                    ...
                                    <div className="navi-text">
                                        <div className="text-dark h6 mb-1">Notifications</div>
                                        <div className="text-muted fs-8">View your Notifications here</div>
                                    </div>
                                </Link>
